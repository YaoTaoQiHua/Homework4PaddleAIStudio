...
def main(data_root, origin_path, split_rate=0.1):

    """

    :param data_root: 根目录
    :param origin_path: 源目录
    :param split_rate: 验证集所占比例
    :return:
    """
    # 保证随机可复现
    random.seed(0)
...
if __name__ == '__main__':
    main(data_root="../Rock_Classification_Dataset",
         origin_path="../Rock_Classification_Dataset/Dataset",
         split_rate=0.2)
